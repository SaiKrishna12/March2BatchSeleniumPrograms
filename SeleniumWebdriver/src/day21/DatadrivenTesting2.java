...
public class DatadrivenTesting2 {
	...
	FileInputStream f=new FileInputStream("E:\\March2Batch\\SeleniumWebdriver\\src\\com\\qedge\\excelfiles\\registration11.xlsx");
	...
	FileOutputStream f1=new FileOutputStream("E:\\March2Batch\\SeleniumWebdriver\\src\\com\\qedge\\resultexcelfiles\\regResults.xlsx");
	wb.write(f1);
	f1.close();
	driver.quit();
	}
